                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
										...
										<input type="text" name="name" id="form_name" class="form-control" value="" required="required" title="name" pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Plz enter on Alphabets ')" onchange="try{setCustomValidity('')}catch(e){}" placeholder="Please enter your Name *" data-error="Name is required."/>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cityzen" id="form_cityzen" class="form-control" value="" pattern=".{13,13}" step="" required="required" title="cityzen" placeholder="Please enter your cityzen *" data-error="Valid cityzen is required.">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="form_phone" type="tel" name="phone" class="form-control" required="required" placeholder="Please enter your phone" data-error="Please,leave us a phone.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>
